...
about = "**About Me**\n\nMy name is Yuno Gasai, A powerful group management bot who can take care of your groups with automated simple regular admin actions!\n\n**My Software Version:** 2.0.1\n**Telethon Version:** 1.21.1\n\n**My Developers:**\n• @Eviral\n• @Amalbiju154\n• @wbavishek\n\nUpdates Channel: [Click Here](https://t.me/Animemusicarchive6)\nSupport Chat: [Click Here](https://t.me/Yeageristbots)\n\nAnd finally thanks for Supporting me😘"
ad_caption = "Hey! I am Yuno Gasai, here to help you manage your groups! I perform most of the admin functions and make your group automated!\n\nJoin @Animemusicarchive6 for updates.\n@Yeageristbots for help and support\n\nYou can checkout more about me via following buttons."
pm_caption = "Hey there! My name is Yuno Gasai - I'm a powerful group management bot Made to help you manage your groups easily!\n\nHit /help to find out more about me and unleash my full potential.\n\n"
pmt = "Hello there! I'm Yuno Gasai\nI'm a Telethon Based group management bot\n with a Much More features! Have a look\nat the following for an idea of some of \nthe things I can help you with.\n\nMain commands available:\n/start : Starts me, can be used to check i'm alive or not.\n/help : PM's you this message.\nExplore My Commands🙃."
        ...
        await tbot.send_message(
            ...
            buttons=[
                [
                  ...
                  [
                    Button.url(
                        "Add Me To Your Group!", "t.me/Yunogasaichatbot?startgroup=true"
                    ),
                ],
            ],
        )
...
async def help(event):
    if not event.is_group:
        ...
        await event.reply(
            ...
            buttons=[[Button.url("Click me for help!", "t.me/Yunogasaichatbot?start=help")]],
        )
...
def paginate_help(event, page_number, loaded_plugins, prefix):
    ...
    pairs = pairs[
            ...
            (
                ...
                custom.Button.url(
                    "My website", "https://yunogasaigroupmangementbot.netlify.app/"
                ),
